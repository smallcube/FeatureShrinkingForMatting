...
class SalObjDataset(Dataset):
    def __init__(self, fg_dir, matte_dir, bg_dir, data_root="data/DIM/", transforms=None, split='train'):
        self.split = split

        filename = data_root + '{}_names.txt'.format(split)
    ...
    def __getitem__(self, idx):
        ...
        image, label_3 = self.process(im_name, bg_name)
    ...
    def process(self, fg_name, bg_name):
        im = cv2.imread(self.fg_dir + fg_name)  #BGR
